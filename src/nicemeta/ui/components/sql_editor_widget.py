    ...
    def create(self) -> ui.element:
        ...
        with ui.column().classes("w-full p-3 bg-white dark:bg-[#1e1e1e] border border-gray-200 dark:border-[#3e3e42]") as container:
            ...
            with ui.row().classes("items-center gap-2 mb-2"):
                ...
                ).props("flat dense").classes("text-gray-600 dark:text-gray-300")
                ...
                ui.label("Ctrl/Cmd + Enter to run").classes("text-xs text-gray-400 dark:text-gray-500")
...
def create_results_table(
    ...
    with ui.card().classes("w-full") as container:
        ...
        with ui.row().classes("items-center gap-4 mb-2"):
            ...
            ui.label(f"{execution_time:.1f}ms").classes("text-sm text-gray-500 dark:text-gray-400")
        ...
        if columns and rows:
            ...
            ui.label("No results").classes("text-gray-500 dark:text-gray-400 p-4")
