        ...
        with ui.card().classes("w-full") as self._container:
            ...
            with ui.row().classes("items-center gap-2 mb-2"):
                ...
                with ui.row().classes("items-center gap-1"):
                    ui.icon("code", size="xs").classes("text-grey-5")
                    ui.label("Python").classes("text-xs text-grey-6 font-mono")
            ...
            with self._error_container:
                with ui.card().classes("w-full border"):
                    with ui.row().classes("items-start gap-2 p-2"):
                        ui.icon("error", size="sm").classes("text-negative mt-0.5")
            ...
            with self._error_container:
                with ui.card().classes("w-full border"):
                    with ui.row().classes("items-center gap-2 p-2"):
                        ...
                        ui.label(message).classes("text-sm text-positive")
            self._error_container.set_visibility(True)
