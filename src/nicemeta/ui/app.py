...
from nicemeta.core.database import close_db, init_db
...
def setup_auth_routes(fastapi_app: FastAPI) -> None:
    ...
    from nicemeta.auth.users import (
        get_auth_router,
        get_register_router,
...
def setup_pages() -> None:
    ...
    from nicemeta.ui.pages.admin import admin_page
    from nicemeta.ui.pages.connections import connections_page
    from nicemeta.ui.pages.dashboard import dashboard_page
    from nicemeta.ui.pages.home import home_page
    from nicemeta.ui.pages.query_builder import query_builder_page
    from nicemeta.ui.pages.sql_editor import sql_editor_page
