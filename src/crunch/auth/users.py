...
from crunch.core.database import get_async_session
...
def get_register_router():
    ...
    from crunch.auth.schemas import UserCreate, UserRead
    return fastapi_users.get_register_router(UserRead, UserCreate)


def get_users_router():
    """Get the users management router."""
    from crunch.auth.schemas import UserRead, UserUpdate
...
def get_verify_router():
    ...
    from crunch.auth.schemas import UserRead
