...
class GitService:
    ...
    async def sync_all(self) -> str:
        ...
        from crunch.services.visualization_service import get_visualization_by_query_id
    ...
    async def import_from_workspace(self) -> str:
        ...
        from crunch.services.query_service import save_query as db_save_query
        from crunch.services.connection_service import get_connections
        ...
        for dash_file in sorted(self.dashboards_dir.glob("*.json")):
            try:
                from crunch.services.dashboard_service import get_dashboard_by_id, create_dashboard as db_create_dashboard
