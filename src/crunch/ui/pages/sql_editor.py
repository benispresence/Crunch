...
from crunch.ui.theme import inject_theme
from crunch.services.visualization_service import (
    get_visualization_by_query_id,
    save_visualization,
)
from crunch.ui.components.sql_editor_widget import (
    SQLEditorWidget,
    create_results_table,
    serialize_value,
)
from crunch.ui.components.python_editor_widget import PythonEditorWidget
from crunch.visualization import (
    ChartConfig,
    ChartFactory,
...
class SQLEditorPage:
    ...
    def _save_query_dialog(self) -> None:
        ...
        from crunch.ui.components.sidebar import get_cached_folder_tree
    ...
    def _apply_agent_sql(self, new_sql: str) -> None:
        ...
        from crunch.ui.components.inline_diff import InlineDiffView
