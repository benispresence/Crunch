...
from crunch.ui.components.sidebar import MetabaseHeader, MetabaseSidebar
from crunch.ui.components.agent_panel import (
    AgentPanel,
    _KEY_ANTHROPIC,
    _KEY_OPENAI,
    _KEY_PROVIDER,
...
from crunch.services.agent_service import ALL_MODELS, ANTHROPIC_MODELS
from crunch.services.git_service import get_git_service, reset_git_service, DEFAULT_WORKSPACE
...
class AdminPage:
    ...
    async def _render_packages_panel(self) -> None:
        ...
        from crunch.services import package_service
        from crunch.visualization.code_executor import CodeExecutor
    ...
    async def _render_git_panel(self) -> None:
        ...
        with ui.column().classes("w-full gap-6 max-w-3xl"):
            ...
            with ui.card().classes("w-full"):
                ...
                async def _do_clone():
                    from crunch.services.git_service import _validate_git_url
